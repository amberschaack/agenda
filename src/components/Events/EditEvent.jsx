...
export default function EditEvent() {
    ...
    const [editEvent, setEditEvent] = useState(eventDetails ?? null);
    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
            ...
            <input id='event-time' type='time' placeholder={editEvent?.event_time} value={editEvent?.event_time} 
                onChange={(event) => setEditEvent({...editEvent, event_time: event.target.value})} />
            <input id='event-name' type='text' placeholder={editEvent?.event_name} value={editEvent?.event_name}
                onChange={(event) => setEditEvent({...editEvent, event_name: event.target.value})} />
            <br></br>
            <input id='event-description' type='text' placeholder={editEvent?.description} value={editEvent?.description}
                onChange={(event) => setEditEvent({...editEvent, description: event.target.value})} />
            <br></br>
            <input id='event-location' type='text' placeholder={editEvent?.location} value={editEvent?.location}
